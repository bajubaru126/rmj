...
export function UserManagementWithVendors() {
  ...
  const findOrCreateVendor = async (vendorName: string, vendorCode: string): Promise<string | undefined> => {
    ...
    try {
      ...
      throw new Error(`Gagal membuat vendor: ${vendorName} - ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
  };
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Kelola vendor sistem</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <button
